    ...
    <div class="content">
      <div class="page_headings">
        ...
        <div class="right">
          ...
          <h2>We have a high skill management team they manage all the activity happen or events comes in travel agency
          </h2>
        </div>
      </div>
      ...
      <div class="right">
        <a name='error'></a>
        <form enctype="multipart/form-data" method="post" action="http://www.shirazitravels.com/contact"
          class="contact_form">
          <ul>
            <!-- Retrieve description data from the DB -->
